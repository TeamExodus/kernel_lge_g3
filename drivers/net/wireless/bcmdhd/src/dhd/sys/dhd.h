 ...
 *
 * $Id: dhd.h 459336 2014-03-03 07:09:45Z $
 */
...
extern int dhdsdio_cis_read(void *bus, uint fn, uint8 *cis_buf, int cis_buf_len);
extern int dhd_check_module_vid(void *bus, osl_t *osh);
